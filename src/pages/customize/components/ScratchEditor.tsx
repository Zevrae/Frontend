...
export default function ScratchEditor({ garments }: { garments: CustomizableGarment[] }) {
    ...
    <div className="flow-screen">
      ...
      <div className="layout">
        <div className="panel">
          ...
          <StepLabel>04 — Upload design</StepLabel>
          <label className="upload-btn" htmlFor="editorUpload">
            ＋ Upload image to canvas
          </label>
          <input id="editorUpload" type="file" accept="image/*" onChange={handleFile} />
          <p className="hint">
            Uploads onto the active view ({activeView}), inside the gold print-area outline. Drag it, or use the
        ...
        <div className="panel right">
          ...
          <p className="hint" style={{ marginTop: 0 }}>
            Place a design on the front, back, or both, pick a size, then generate to see the final product and
            add it to your bag.
          </p>
